<%-- 
    Document   : NoDataFound
    Created on : 30 Aug 2023, 11:07:37 am
    Author     : ariff
--%>
    ...
    <body>
        ...
        <form action="MainController" method="get">
            <div class="search-block">
                ...
                <h4 class="red-font">NO DATA FOUND</h4>
            </div>
        </form>

            <button class="nodata-block-button" onclick="document.location = 'RegisterPage.jsp'" class="register-button">Register New Visitor</button>
